                ...
                <div class="card-body">
                    <form method="get" action="empDetails">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="fullName" class="form-control" readonly="readonly"
                                       value="${user.fullName}" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="email" class="form-control" readonly="readonly"
                                       value="${user.email}" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <c:forEach var="address" items="${user.address}" varStatus="addressStatus">
                            <div class="address-container">
                                <div class="mb-3 row">
                                    <label class="col-sm-4 col-form-label">Permanent Address:</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="permanenetAddress" class="form-control"
                                               readonly="readonly" value="${address.permanenetAddress}" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="temporaryAddress" class="form-control"
                                               readonly="readonly" value="${address.temporaryAddress}" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                        ...
                        <div class="text-center">
                            <a href="edit-details" class="btn btn-primary">Back</a>
                        </div>
                    </form>
                </div>
            </div>
