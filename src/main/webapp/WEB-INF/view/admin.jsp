...
<%--                     <th scope="row">${emp.id}</th> --%>
                    ...
                    <td>
                    <a href="viewDetails/${emp.id}"
											class="btn btn-sm btn-primary-view"
											style="background-color: red; color: white;">View</a>
                      <a href="editDetails/${emp.id}" class="btn btn-sm btn-primary">Edit</a>
                      <a href="deleteEmployees/${emp.id}" class="btn btn-sm btn-danger">Delete</a>
                    </td>
                  </tr>
                </c:forEach>
              </tbody>
