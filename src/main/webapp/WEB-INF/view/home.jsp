	...
	<header class="header">
		...
		<nav>
			<ul class="nav justify-content-center">
				...
				<li class="nav-item"><a class="nav-link" href="empDetails">Employee
						Details</a></li>
			...
			<div class="col-md-4">
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">Comprehensive Employee Database: Maintain
							a centralized repository of employee information, including
							personal details, employment history, and qualifications.</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">Performance Evaluation: Implement a
							performance evaluation system to assess employee performance, set
							goals,regular activities and facilitate performance reviews...</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">Leave Management: Automate leave
							requests, approvals, and tracking, ensuring smooth management of
							employee time off.</p>
					</div>
				</div>
			</div>
